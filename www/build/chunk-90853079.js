import { w as writeTask } from './chunk-91927964.js';
...
const iosTransitionAnimation = () => __sc_import_app('./ios.transition-eb538b34.js');
const mdTransitionAnimation = () => __sc_import_app('./md.transition-2a37ef9c.js');
...
const animation = async (animationBuilder, opts) => {
    ...
    const trans = await __sc_import_app('./index-d3aa5dba.js').then(mod => mod.create(animationBuilder, opts.baseEl, opts));
