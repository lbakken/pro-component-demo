...
const patchEsm = () => {
    ...
    if (!(win.CSS && win.CSS.supports && win.CSS.supports('color', 'var(--c)'))) {
        // @ts-ignore
        return __sc_import_app('./css-shim-3ea8955c-3ea8955c.js');
    }
...
const patchBrowser = async () => {
    ...
    if (importMeta !== '') {
        ...
        if (!window.customElements) {
            // @ts-ignore
            await __sc_import_app('./dom-860d8016-860d8016.js');
        }
...
const parseClassList = (value) => (!value) ? [] : value.split(/ +/g);
...
export { Build as B, Host as H, patchEsm as a, bootstrapLazy as b, getElement as c, createEvent as d, config as e, getIonMode as f, globals as g, h, isPlatform as i, readTask as j, getAssetPath as k, getMode as l, getConnect as m, getContext as n, patchBrowser as p, registerInstance as r, writeTask as w };
