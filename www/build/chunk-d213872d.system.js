...
System.register(['./chunk-5603b3cb.system.js'], function (exports, module) {
    ...
    return {
        ...
        execute: function () {
            ...
            var iosTransitionAnimation = function () { return module.import('./ios.transition-27e22831.system.js'); };
            var mdTransitionAnimation = function () { return module.import('./md.transition-e261d6de.system.js'); };
            var transition = exports('t', function (opts) {
            ...
            var animation = function (animationBuilder, opts) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            return [4 /*yield*/, module.import('./index-57fba54f.system.js').then(function (mod) { return mod.create(animationBuilder, opts.baseEl, opts); })];
                        case 2:
                            trans = _a.sent();
            ...
            var lifecycle = exports('l', function (el, eventName) {
                if (el) {
            ...
            var deepReady = exports('d', function (el) { return __awaiter(_this, void 0, void 0, function () {
            ...
            var setPageHidden = exports('s', function (el, hidden) {
                if (hidden) {
