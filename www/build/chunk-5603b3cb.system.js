...
System.register([], function (exports, module) {
    ...
    return {
        execute: function () {
            ...
            var readTask = exports('j', /*@__PURE__*/ queueTask(queueDomReads, false));
            ...
            var setAccessor = function (elm, memberName, oldValue, newValue, isSvg, flags) {
                ...
                if (BUILD.vdomClass && memberName === 'class') {
                    ...
                    classList.remove.apply(classList, parseClassList(oldValue));
                    classList.add.apply(classList, parseClassList(newValue));
                }
            ...
            var parseClassList = function (value) { return (!value) ? [] : value.split(/ +/g); };
            ...
            var getMode = exports('l', function (ref) { return getHostRef(ref).$modeName$; });
            ...
            var createEvent = exports('d', function (ref, name, flags) {
            ...
            var getAssetPath = exports('k', function (path) {
                var assetUrl = new URL(path, plt.$resourcesUrl$);
                return (assetUrl.origin !== win.location.origin)
                    ? assetUrl.href
                    : assetUrl.pathname;
            });
            var getConnect = exports('m', function (_ref, tagName) {
            ...
            var getContext = exports('n', function (_elm, context) {
            ...
            var isPlatform = exports('i', function (win, platform) { return getPlatforms(win).indexOf(platform) > -1; });
            ...
            var config = exports('e', /*@__PURE__*/ new Config());
            ...
            var mode;
            var getIonMode = exports('f', function (ref) {
