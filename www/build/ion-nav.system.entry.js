...
System.register(['./chunk-5603b3cb.system.js', './chunk-05185aad.system.js', './chunk-307e3eda.system.js', './chunk-d213872d.system.js'], function (exports, module) {
    'use strict';
    var registerInstance, createEvent, Build, getIonMode, config, h, getElement, assert, attachComponent, lifecycle, LIFECYCLE_WILL_UNLOAD, LIFECYCLE_WILL_LEAVE, LIFECYCLE_DID_LEAVE, transition, setPageHidden;
    return {
        setters: [function (module) {
                ...
                lifecycle = module.l;
                LIFECYCLE_WILL_UNLOAD = module.L;
                LIFECYCLE_WILL_LEAVE = module.a;
                LIFECYCLE_DID_LEAVE = module.b;
                transition = module.t;
                setPageHidden = module.s;
            }],
        execute: function () {
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    this.rootChanged();
                                    _a = this;
                                    return [4 /*yield*/, module.import('./swipe-back-c3095c6d.system.js')];
                                case 1:
