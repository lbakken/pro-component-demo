...
const patchBrowser = async () => {
    // @ts-ignore
    const importMeta = (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('chunk-4c2d6ff3.js', document.baseURI).href));
    if (importMeta !== '') {
...
const setValue = (ref, propName, newVal, cmpMeta) => {
    ...
    if (newVal !== oldVal && ( !(flags & 8 /* isConstructingInstance */) || oldVal === undefined)) {
        ...
        if ( hostRef.$lazyInstance$) {
            ...
            if ( cmpMeta.$watchers$ && flags & 128 /* isMethodsCallable */) {
