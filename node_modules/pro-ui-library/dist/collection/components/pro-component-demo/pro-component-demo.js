...
export class ProComponentDemo {
    ...
    render() {
        return (h(Host, null,
            h("pro-header", null,
                h("span", { class: "special" }, "Hey there!"),
            ...
            h("ion-content", null,
                h("pro-grid", null,
                    h("pro-row", null,
                        h("pro-col", null,
                            h("pro-card", null,
                                h("pro-content", null,
                                    h("p", null,
                                        h("span", { class: "special" }, "Uh oh!"),
                                        " Major thunderstorms in the past few days!"),
                                    h("pro-image", { src: "", id: "changing-icon" }),
                    ...
                    h("form", { onSubmit: () => console.log(event) },
                        h("pro-row", null,
                            h("pro-col", { size: "6" },
                                h("pro-card", null,
                                    h("pro-content", null,
