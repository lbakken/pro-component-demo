...
const COMPILER_BUILD = {
    id: '20190722222612',
    minfyJs: 'terser4.1.2_3',
    optimizeCss: 'autoprefixer9.6.1_cssnano4.1.10_postcss7.0.17_3',
    transpiler: 'typescript3.5.3_3'
};

const removeStencilImport = (importNode) => {
...
const transformToLazyComponentText = (compilerCtx, buildCtx, opts, cmp, inputText) => {
    let outputText = null;
    try {
        const transpileOpts = {
            compilerOptions: {
...
const lazyComponentTransform = (compilerCtx, opts) => {
    return transformCtx => {
        return tsSourceFile => {
...
function validateEventName(config, diagnostics, node, eventName) {
